...
class _AuthorizationState extends State<Authorization> {
  ...
  void initState() {
    ...
    if (_accountService.rememberMe && _accountService.savedLogin != null) {
  ...
  Widget _fields(AccountService accountService) {
    return Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      //if (accountService.rememberMe != null)
      Container(
            ...
            GestureDetector(
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: accountService.rememberMe
                          ? AppElements.textFieldEnabled.color()
                          : AppElements.textFieldDisabled.color(),
                      width: 2,
                    )),
                child: accountService.rememberMe
                    ? Icon(
                        Icons.done,
              ...
              onTap: () {
                accountService.rememberMe = !accountService.rememberMe;
              },
            ),
            Text(
